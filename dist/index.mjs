...
var BaseClient = class {
	...
	constructor(config) {
		...
		this.httpClient.interceptors.response.use((response) => response, (error) => {
			...
			if (axios.isAxiosError(error) && error.request) throw new QuidaxError(0, "network_error", error.message);
			throw error;
		});
	}
...
//#endregion
export { BaseClient, DepositsModule, FeesModule, MarketsModule, OrdersModule, Quidax, Quidax as default, QuidaxError, RampModule, SwapModule, TradesModule, UsersModule, WalletsModule, WithdrawalsModule };
